...
if(AsioGit_CLONE_RESULT)
	...
	file(COPY ${AsioGit_CLONE_RESULT}/asio/include/ DESTINATION ${CMAKE_CURRENT_LIST_DIR})
	file(COPY ${AsioGit_CLONE_RESULT}/asio/LICENSE_1_0.txt DESTINATION ${CMAKE_CURRENT_LIST_DIR})
	file(COPY ${AsioGit_CLONE_RESULT}/src/asio.cpp DESTINATION ${CMAKE_CURRENT_LIST_DIR}/src)
	file(COPY ${AsioGit_CLONE_RESULT}/src/asio_ssl.cpp DESTINATION ${CMAKE_CURRENT_LIST_DIR}/src)
