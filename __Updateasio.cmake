...
if(AsioGit_CLONE_RESULT)
	...
	file(COPY ${AsioGit_SOURCE_DIR}/src/asio.cpp DESTINATION ${CMAKE_CURRENT_LIST_DIR}/src)
	file(COPY ${AsioGit_SOURCE_DIR}/src/asio_ssl.cpp DESTINATION ${CMAKE_CURRENT_LIST_DIR}/src)
