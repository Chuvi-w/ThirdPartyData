...
if(md4c_git_CLONE_RESULT)
	...
	file(GLOB_RECURSE  MD4CFiles ${md4c_git_SOURCE_DIR}/src/*.h ${md4c_git_SOURCE_DIR}/src/*.c )
	file(GLOB_RECURSE  MD2HTMLiles ${md4c_git_SOURCE_DIR}/md2html/*.h ${md4c_git_SOURCE_DIR}/md2html/*.c)
